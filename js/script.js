...
const elementSearch = document.querySelectorAll('.page__search')
...
const elementForm = document.querySelector('.top-header-form__container')
  ...
  if (Width <= 1280) {
     ...
     functionehead( elementItemMenu.after(elementLogo) , elementSearch[0].style.display = 'none' , elementSearch[1].style.display = 'flex'  , headerContent.append(elementContact) , elementContact.classList.add('top-header__columns') )   
      : 
      functionehead( headerContent.prepend(elementLogo) , elementSearch[0].style.display = 'flex' , elementSearch[1].style.display = 'none' ,  elementToheaderColumnsMenus.append(elementContact)  , elementContact.classList.remove('top-header__columns')  )

      function functionehead(sids , long , label , menu , q ) {
  return sids ;
  return  long ; 
  return label ;
  return  menu ; 
